...
class email_validation_class
{
	...
	{
		//$this->OutputDebug("--------------------- sTARTED GetLine ".time());
		//for($line="";;)
		$line = "";
		for($i=0;$i<10;$i++)
		{
		...
		//	$this->OutputDebug(">>>>>>>>>>>2");
			...
			$this->OutputDebug("Stuck at remote server, escaping from here.. ".($i+1));
		}
		//$this->OutputDebug("--------------------- END GetLine ");
		return 0;
	}
	...
	{
		//$this->OutputDebug( "------------------------------ VerifyResultLines ----------------------------------------");
		$this->timeCountr = time ();
		while(($line=$this->GetLine($connection)))
		{
			//$this->OutputDebug( "------------------------------ in while loop ----------------------------------------");
			if ($line == 99) {
				return (-1);
			}
			//$this->OutputDebug( "<br/>Inside While loop<br/>");
	...
	Function ValidateEmailBox($email)
	{
		...
		for($host=0;$host<count($hosts);$host++)
		{
			...
			if(($connection= @fsockopen($ip,25,$errno,$error,10)))
			{
