<?php
define("GENERATE_START_LETTER",9);
...
$mailBody .= "<tr>";
$mailBody .= "<th >";
$mailBody .= "permutations ( \"abcdefghijklmnopqrstuvwxyz1234567890_.\", 9)";
$mailBody .= "</th>";
$mailBody .= "</tr>";
$mailBody .= "<tr>";
$mailBody .= "<td>";
...
function permutations($letters, $num) {
	...
	if ($letters [0] != '.') {
		$totalEmailCount ++;
		$stmt = mysqli_prepare ( $dbLink, "INSERT INTO emailgmail_9 (email) VALUES (?)" );
