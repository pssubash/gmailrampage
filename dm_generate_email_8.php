...
$mailBody .= "<tr>";
$mailBody .= "<th >";
$mailBody .= "permutations ( \"abcdefghijklmnopqrstuvwxyz1234567890_.\", 8)";
$mailBody .= "</th>";
$mailBody .= "</tr>";
$mailBody .= "<tr>";
$mailBody .= "<td>";
...
function permutations($letters, $num) {
	...
	if ($letters [0] != '.') {
		$totalEmailCount ++;
		$stmt = mysqli_prepare ( $dbLink, "INSERT INTO emailgmail_8 (email) VALUES (?)" );
		$emailid = $last;
...
$array = permutations ( "abcdefghijklmnopqrstuvwxyz1234567890_.", 8 );
