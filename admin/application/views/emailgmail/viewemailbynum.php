...
<div id="main">
	...
	<div class="full_w">
		...
		<div class="pagination">
						...
						<a href="<?php echo base_url()?>index.php//gmailemail/viewemail/en/<?php echo $chartype?>/50">50</a>
						<a href="<?php echo base_url()?>index.php//gmailemail/viewemail/en/<?php echo $chartype?>/100">100</a>
						<a href="<?php echo base_url()?>index.php//gmailemail/viewemail/en/<?php echo $chartype?>/500">500</a>
