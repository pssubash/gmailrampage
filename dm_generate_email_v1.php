...
$mailBody .= "<tr>";
$mailBody .= "<th >";
$mailBody .= "permutations ( \"abcdefghijklmnopqrstuvwxyz1234567890.\", $generateNum)";
$mailBody .= "</th>";
$mailBody .= "</tr>";
$mailBody .= "<tr>";
$mailBody .= "<td>";
...
function permutations($letters, $num) {
	...
	if ($letters [0] != '.' && $letters[strlen($letters[0])- 1] != '.') {
		$totalEmailCount ++;
		$stmt = mysqli_prepare ( $dbLink, "INSERT INTO emailgmail_$num (email) VALUES (?)" );
...
$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
			...
			$mailBody .= "<tr>";
			$mailBody .= "<th >";
			$mailBody .= "permutations ( \"abcdefghijklmnopqrstuvwxyz1234567890.\", $num)";
			$mailBody .= "</th>";
			$mailBody .= "</tr>";
			$mailBody .= "<tr>";
			$mailBody .= "<td>";
			...
			$mailBody .= "</body>";
			$totalEmailCount = 0;
			mail(ALERT_EMAIL, str_replace("<<<letter>>>", $num, ALERT_EMAIL_SUBJECT), $mailBody);
...
$array = permutations ( "abcdefghijklmnopqrstuvwxyz1234567890", $generateNum ); // Set your permutaion here
